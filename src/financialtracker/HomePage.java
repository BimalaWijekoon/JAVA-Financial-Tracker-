...
public class HomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(30, 244, 194));

        jPanel1.setBackground(new java.awt.Color(7, 7, 77));
        jPanel1.setMaximumSize(new java.awt.Dimension(1130, 700));
        jPanel1.setMinimumSize(new java.awt.Dimension(1130, 700));

        jLabel1.setBackground(new java.awt.Color(7, 7, 77));
        jLabel1.setFont(new java.awt.Font("Showcard Gothic", 1, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(165, 176, 215));
        ...
        jButton1.setText("TAP TO CONTINUE ");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/financialtracker/home.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Rockwell Condensed", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(153, 157, 221));
        jLabel2.setText("Smart Tracking for Smarter Savings");
